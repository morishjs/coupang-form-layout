...
var CustomerForm = function (props) { return (react_1.default.createElement(react_admin_1.SimpleForm, __assign({ initialValues: { firstname: 'John', name: 'Doe' } }, props),
...
var CustomerCreate = function (props) { return (react_1.default.createElement(react_admin_1.Create, __assign({}, props),
    react_1.default.createElement(exports.CustomerForm, null))); };
exports.CustomerCreate = CustomerCreate;
var CustomerList = function (props) { return (react_1.default.createElement(react_admin_1.List, __assign({}, props, { hasCreate: true, sort: { field: 'id', order: 'DESC' }, empty: false }),
