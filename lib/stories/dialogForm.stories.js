...
var CustomerListDialogs = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(src_1.CreateDialog, { basePath: basePath, resource: resource, fullWidth: true, maxWidth: "md" },
            react_1.default.createElement(common_1.CustomerForm, null)),
        react_1.default.createElement(src_1.EditDialog, { basePath: basePath, resource: resource, fullWidth: true, maxWidth: "md" },
            react_1.default.createElement(common_1.CustomerForm, null))));
};
var Basic = function () {
...
var CustomerListDialogsWithTitles = function (props) {
    var basePath = props.basePath, resource = props.resource;
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(common_1.CustomerList, __assign({}, props)),
        react_1.default.createElement(src_1.CreateDialog, { basePath: basePath, resource: resource, fullWidth: true, maxWidth: "md", title: "Create a new customer" },
            react_1.default.createElement(common_1.CustomerForm, null)),
        react_1.default.createElement(src_1.EditDialog, { basePath: basePath, resource: resource, fullWidth: true, maxWidth: "md", title: react_1.default.createElement(EditDialogTitle, null) },
            react_1.default.createElement(common_1.CustomerForm, null))));
};
...
var CustomerListDialogsWithTabbedForm = function (props) {
    var basePath = props.basePath, resource = props.resource;
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(common_1.CustomerList, __assign({}, props)),
        react_1.default.createElement(src_1.CreateDialog, { basePath: basePath, resource: resource, fullWidth: true, maxWidth: "md" },
